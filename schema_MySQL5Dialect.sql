...
create table STATION (ID integer not null auto_increment, CREATED_AT datetime not null, MODIFIED_AT datetime, apartment varchar(255), houseNo varchar(255), street varchar(255), zipCode varchar(255), x double precision not null, y double precision not null, PHONE varchar(16), TRANSPORT_TYPE varchar(255) not null, CREATED_BY integer, MODIFIED_BY integer, CITY_ID integer, primary key (ID));
